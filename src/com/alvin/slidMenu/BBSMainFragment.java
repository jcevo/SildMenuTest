 ...
 *
 */
public class BBSMainFragment extends TopBannerFragment{
	public static int SLIDE_MENU_STATE = MainSlidingActivity.LEFT_AVAILABLE; //记录资讯页slidingmenu状态
	private String TAG = "BBSMainFragment";
	private String[] CONTENT = new String[] { "热门", "车系","地区","综合"};
	public 	ViewPager pager = null;
	private MainSlidingActivity mainActivity = null;
	private TabPageIndicator pageChangeindicator = null;
	private BBSViewPagerChangerListener pageChangelistener = null;
	private BBSViewPagerAdapter pageAdapter = null;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View layout = localLayoutInflater.inflate(R.layout.bbs_main, container,false);
		initView(layout);
		//初始化SlidingMenu状态
	...
	private void initView(View layout){
		...
		setTopBannerTittle(R.drawable.app_bbs_name);
...
//			Fragment fragment = new  BBSHotTopicFragment();
//			Bundle bundle = new Bundle();  
//            bundle.putString("key", CONTENT[position]); 
...
//		AutoBbsRecentBrowserFragment.class,AutoBBSHomeMainFragment.class,AutoBbsCarSerialsFragment.class,BBSComprehensiveFragment.class
	};
