...
public class AnimationUtils {
	private static boolean translatAnimSwitch;
	private static boolean sacleAmimSwitch;
		...
		if (params.getView() != null) {
			if (!translatAnimSwitch) {
				...
				anim.setAnimationListener(new AnimationListener() {
					TranslateAnimInterface transslateInterface = params.getTranlateInterface();
					@Override
...
//						params.getView().clearAnimation();
	...
	public static void setScaleAnimation(final AinmParams params) {
		if (params.getView() != null) {
			if (!sacleAmimSwitch) {
				...
				params.getView().startAnimation(anim);
				anim.setAnimationListener(new AnimationListener() {
					ScaleAnimInterface scaleInterface = params.getScaleInterface();
					@Override
					public void onAnimationStart(Animation animation) {
	...
	public static class AinmParams {
		...
		public AinmParams setTime(int time) {
			this.time = time;
			return this;
		}
