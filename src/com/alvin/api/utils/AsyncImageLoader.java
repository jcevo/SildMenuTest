...
public class AsyncImageLoader {
    ...
    public static Drawable loadImageByUrl(String imageUrl) {
        synchronized (imageUrl) {
            ...
            try {
                httpDownloadItem = HttpUtils
                        .invokeWithCache(imageUrl, CacheUtils.CACHE_EXTERNAL, ImageCacheTime, false);
            } catch (Exception e) {
            ...
            if (isError) {
                ...
                Drawable drawable = getDrawableByFile(httpDownloadItem.getInputStream());
